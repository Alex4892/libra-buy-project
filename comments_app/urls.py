...
from .views import (add_comment_view, delete_comment_view, 
                    edit_comment_view, change_comment_status)
...
urlpatterns = [
    ...
    path('change-comment-status/<int:book_id>/', change_comment_status, name='change_comment_status')
]
